...
BEGIN_MESSAGE_MAP(CCreateWaveDlg, CDialog)
	...
	ON_BN_CLICKED(IDC_SEPERATE_CHANNEL_EXPORT, &CCreateWaveDlg::OnBnClickedSeperateChannelExport)
END_MESSAGE_MAP()
...
void CCreateWaveDlg::OnBnClickedBegin()
{
	...
	ProgressDlg.CancelRender = false;
...
void CCreateWaveDlg::OnBnClickedSeperateChannelExport()
{
