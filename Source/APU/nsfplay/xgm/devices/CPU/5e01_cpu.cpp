...
I5E01_CPU::I5E01_CPU (double clock)
{
...
{
  static_cast < I5E01_CPU * >(__THIS)->Write (adr, val);
}

UINT32 Callback readByte (void *__THIS, UINT32 adr)
{
  UINT32 val = 0;
  static_cast < I5E01_CPU * >(__THIS)->Read (adr, val);
  return val;
}

void I5E01_CPU::run_from (UINT32 address)
{
	#if TRACE
...
void I5E01_CPU::SetMemory (IDevice * b)
{
  bus = b;
}

bool I5E01_CPU::Write (UINT32 adr, UINT32 val, UINT32 id)
{
  #if DEBUG_RW
...
bool I5E01_CPU::Read (UINT32 adr, UINT32 & val, UINT32 id)
{
  if (bus)
  {
...
void I5E01_CPU::SetLogger (CPULogger* logger)
{
	log_cpu = logger;
}

unsigned int I5E01_CPU::GetPC() const
{
	return context.PC;
}

void I5E01_CPU::StealCycles(unsigned int cycles)
{
	stolen_cycles += cycles;
}

void I5E01_CPU::EnableNMI(bool enable)
{
	enable_nmi = enable;
}

void I5E01_CPU::UpdateIRQ(int device, bool irq)
{
