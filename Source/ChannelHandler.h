...
static const int DUTY_5E01_FROM_VRC6[]   = {0, 0, 1, 1, 2, 2, 3, 3};		// // //
static const int DUTY_AY8930_FROM_2A03[] = {2, 3, 4, 5};
static const int DUTY_AY8930_FROM_VRC6[] = {1, 2, 2, 3, 3, 3, 3, 4};
